...
public class ActiveMQService implements MQService {
    ...
    /**
     * 1.1 Create a new connection using a ConnectionFactory - Hint: One line of code
     */
    /**
    ...
    public Destination createDestination(Session session, String topicName) throws JMSException {
        // 1.4.1 create a destination using the create topic method
        return session.
    }
    ...
    public MessageConsumer createMessageConsumer(Session session, Topic topic, String subscriberName) throws JMSException {
        // 1.5.1 create a message consumer using the session's create durable subscriber method the given topic and the subscriber name
        return session.
    }
